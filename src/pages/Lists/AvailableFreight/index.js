...
import AvailableFreightList from "./AvailableFreightList"
      ...
      <React.Fragment>
        <div className="page-content">
          ...
          <Container fluid>
            ...
            {/* Render Breadcrumb */}
            <Breadcrumbs
              title={this.props.t("Available Freight")}
              breadcrumbItem={this.props.t("Available Freight")}
            />

            <Row>
              <Col lg="12">
                <AvailableFreightList/>
              </Col>
            </Row>
...
AvailableFreight.propTypes = {
  t: PropTypes.any,
  chartsData: PropTypes.any,
  onGetChartsData: PropTypes.func
}

const mapStateToProps = ({ AvailableFreight }) => ({
...
)(withTranslation()(AvailableFreight))
